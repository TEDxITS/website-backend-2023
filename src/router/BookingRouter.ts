...
import { createBooking, getAllBookings, getBookingById, getBookingDetailById, getBookingDetailsByBookingId, getUserBookings, uploadPaymentProof, verifyBooking } from '../controller/BookingController';
